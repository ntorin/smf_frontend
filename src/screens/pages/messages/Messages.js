...
import { CONVERSATIONS_POST_FETCH, CONVERSATIONS_PUT_UPDATE } from 'helpers/apicalls';
    ...
    muteConversation() {
        if (!this.state.selectedConversation.is_muted) {
            Alert.alert('Mute Conversation', 'Would you like to mute this conversation?',
                [{
                    text: "YES", onPress: () => {
                        CONVERSATIONS_PUT_UPDATE(this.state.selectedConversation.id, true)
                            .then((responseJSON) => {
            ...
            Alert.alert('Unmute Conversation', 'Would you like to unmute this conversation?',
                [{
                    text: "YES", onPress: () => {
                        CONVERSATIONS_PUT_UPDATE(this.state.selectedConversation.id, false)
                            .then((responseJSON) => {
                                this.setState({ forceUpdate: true })
                            })
                    }
