...
import UserFollows from 'pages/profile/UserFollows';
import UserGroups from 'pages/profile/UserGroups';
...
export default function () {
  ...
  Navigation.registerComponent('smf_frontend.UserGroups', () => UserGroups);
